...
question_1 = [
    ("Cтимуляція клітора", 5),
    ("Вагінальне проникнення", 4),
    ("Не можу обрати між першим і другим", 2),
    ("Не знаю, але хочу дізнатися", 1),
]
question_2 = [
    ("Широка та гучна вібрація", 5),
    ("Інтенсивна, цілеспрямована стимуляція", 4),
    ("Ніжний дотик", 2),
    ("Все, що схоже на оральний секс", 1),
]
question_3 = [
    ("10 хвилин ⏱️", 2),
    ("Досить для солідної сесії 😊", 4),
    ("Весь день, крихітко 😎", 5),
]
question_4 = [
    ("Жодного, це мій перший раз 🙄", 1),
    ("Два чи три 🤫", 4),
